...
namespace face
{
  ...
  FaceModel::FaceModel()
  {
    ...
    // The anatomy of the 66-point layout: the contour and brow chains, the nose, and the
    // closed rings of the eyes and both lips. Used to be read from face.con of the CLM.
    mConnections = {
      // Contour
